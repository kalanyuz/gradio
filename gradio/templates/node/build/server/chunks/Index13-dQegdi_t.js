...
import { B as Block, S as Static, f as BlockLabel, Q as Code$2, h as Empty, j as IconButton, z as Copy$1, D as DownloadLink, k as Download$1, i as IconButtonWrapper, V as getWorkerProxyContext } from './2-DWTiTXXU.js';
...
const lang_map = {
  python: () => import('./index29-C72UrLvT.js').then((m) => m.python()),
  ...
  markdown: async () => {
    const [md, frontmatter] = await Promise.all([
      import('./index30-Ta-yefW5.js'),
      import('./frontmatter-CaW6AiJp.js')
    ]);
    return md.markdown({ extensions: [frontmatter.frontmatter] });
  },
  json: () => import('./index34-DZ_0AI_z.js').then((m) => m.json()),
  html: () => import('./index31-ocMBXpqT.js').then((m) => m.html()),
  css: () => import('./index32-8XmyQ4UG.js').then((m) => m.css()),
  javascript: () => import('./index33-B98nYVqW.js').then((m) => m.javascript()),
  jinja2: () => import('./jinja2-BxhAu_54.js').then(
    (m) => StreamLanguage.define(m.jinja2)
  ),
  typescript: () => import('./index33-B98nYVqW.js').then(
...
//# sourceMappingURL=Index13-dQegdi_t.js.map
