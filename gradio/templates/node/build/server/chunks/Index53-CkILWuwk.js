...
import { B as Block, S as Static, f as BlockLabel, y as File$1, h as Empty, U as UploadText, i as IconButtonWrapper, j as IconButton, J as Undo, k as Download } from './2-DWTiTXXU.js';
import { U as Upload, M as ModifyUpload } from './ModifyUpload-CYAgCTxV.js';
...
async function loadCanvas3D$1() {
  const module = await import('./Canvas3D-CBq70C73.js');
  return module.default;
}
async function loadCanvas3DGS$1() {
  const module = await import('./Canvas3DGS-CFnwXpqu.js');
  return module.default;
}
...
//# sourceMappingURL=Index53-CkILWuwk.js.map
