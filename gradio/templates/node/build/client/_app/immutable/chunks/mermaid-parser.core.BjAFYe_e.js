...
import { b2 as createAssigner, b3 as isPrototype, aw as isArrayLike, aO as copyObject, aA as assignValue, ax as isArray, aa as baseRest, ab as isArrayLikeObject, aE as baseAssignValue, aH as isObjectLike, aI as baseGetTag, aT as nodeUtil, aF as baseUnary, ad as isFunction, ae as isEmpty, ay as identity, as as isObject } from "./mermaid.core.BIYikibP.js";
import { k as keys, j as baseEach, g as baseIteratee, S as SetCache, w as arrayIncludes, x as cacheHas, c as baseFlatten, v as values, y as baseIndexOf, l as arrayMap, z as getAllKeysIn, A as arrayFilter, B as baseFilter, C as arraySome, a as baseUniq, d as forEach, i as isUndefined, r as reduce, f as filter, D as noop } from "./_baseUniq.a9IudB_W.js";
import { j as toInteger, m as map, d as basePickBy, f as flatten, g as find, i as defaults, h as has, l as last, e as min } from "./_basePickBy.Bm9GBEs2.js";
import { c as clone } from "./clone.Dy0xZHIt.js";
...
var initializers = {
  info: /* @__PURE__ */ __name(async () => {
    const { createInfoServices: createInfoServices2 } = await __vitePreload(() => import("./info-46DW6VJ7.BpCtAiVu.js"), true ? [] : void 0, import.meta.url);
    const parser = createInfoServices2().Info.parser.LangiumParser;
    parsers.info = parser;
  }, "info"),
  packet: /* @__PURE__ */ __name(async () => {
    const { createPacketServices: createPacketServices2 } = await __vitePreload(() => import("./packet-W2GHVCYJ.IVnBryg5.js"), true ? [] : void 0, import.meta.url);
    const parser = createPacketServices2().Packet.parser.LangiumParser;
    parsers.packet = parser;
  }, "packet"),
  pie: /* @__PURE__ */ __name(async () => {
    const { createPieServices: createPieServices2 } = await __vitePreload(() => import("./pie-BEWT4RHE.CNfe0VpA.js"), true ? [] : void 0, import.meta.url);
    const parser = createPieServices2().Pie.parser.LangiumParser;
    parsers.pie = parser;
  }, "pie"),
  architecture: /* @__PURE__ */ __name(async () => {
    const { createArchitectureServices: createArchitectureServices2 } = await __vitePreload(() => import("./architecture-I3QFYML2.B6t9YDVG.js"), true ? [] : void 0, import.meta.url);
    const parser = createArchitectureServices2().Architecture.parser.LangiumParser;
    parsers.architecture = parser;
  }, "architecture"),
  gitGraph: /* @__PURE__ */ __name(async () => {
    const { createGitGraphServices: createGitGraphServices2 } = await __vitePreload(() => import("./gitGraph-YCYPL57B.B5s3Ukmy.js"), true ? [] : void 0, import.meta.url);
